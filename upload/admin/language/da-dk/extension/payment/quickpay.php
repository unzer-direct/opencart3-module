<?php
// Heading
$_['heading_title'] = 'QuickPay';

// Text
$_['text_extension']                 = 'Udvidelser';
$_['text_success']                   = 'Sådan! Ændringerne til dine QuickPay-indstillinger er blevet gemt.';
$_['text_edit']                      = 'Rediger QuickPay';
$_['text_quickpay']                  = '<a target="_blank" href="https://quickpay.net"><img style="height: 30px;" src="view/image/extension/payment/quickpay.svg" alt="Quickpay" title="Quickpay" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['help_quickpay_setup']      = '<a target="_blank" href="https://learn.quickpay.net/helpdesk/en/articles/integrations/opencart/">Klik her</a> for at lære hvordan du opsætter din QuickPay-konto.';
...
$_['help_text_on_statement']   = 'Tekst der skal vises på kortholders kontooversigt. Max 22 ASCII karakterer. Supporteres i øjeblikket kun af QuickPay.';
...
$_['help_order_number_prefix'] = 'Indtast en streng, hvis du ønsker at prefixe det ordrenummer, der sendes til QuickPay. Dette har ikke effekt på ordrenumrene i butikken.';
$_['tab_setting']              = 'Indstillinger';
$_['tab_recurring']            = 'Abonnementer';


// Error
$_['error_permission']      = 'Advarsel: Du har ikke rettigheder til at administrere QuickPay!';
